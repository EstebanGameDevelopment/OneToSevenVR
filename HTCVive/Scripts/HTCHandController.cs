...
namespace YourVRExperience.VR
{
    public class HTCHandController : MonoBehaviour
    {
        ...
        private void SetMainLaserPoint(GameObject _laserPointer)
        {
            ...
            SystemEventController.Instance.DispatchSystemEvent(EVENT_HTCHANDCONTROLLER_UPDATE_LASER, LaserPointer, (m_handTypeSelected == 1));
        }
        ...
        private void OnSystemEvent(string _nameEvent, object[] _parameters)
        {
            ...
            {
                bool isHandRight = (bool)_parameters[0];
                if (isHandRight)
                {
